# python 36_G0080_CobaltGroup_Russia.py
...
# ==============================================================================
# 2. Extracted Input Data (Cobalt Group / G0080)
# ==============================================================================

# Input data extracted from the document (36_G0080_CobaltGroup_Russia.docx)
APT_GROUP_INFO = {
    "name": "Cobalt Group",
    "mitre_id": "G0080", 
    "search_tags": [
        # Primary Identifiers
        "CobaltGroup", "G0080", "COBALTSPIDER", "CobaltGang",
        
        # Aliases and Campaign Names
        "GOLDKINGSWOOD", "MuleLibra",
        
        # Associated Malware and Tools
        "CobaltStrike", "MBRkiller", "SpicyOmelette",
        "MicrosoftWordIntruder", "MWI"
    ]
}
