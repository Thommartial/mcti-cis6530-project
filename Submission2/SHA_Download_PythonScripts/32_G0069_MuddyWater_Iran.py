# python 32_G0069_MuddyWater_Iran.py

# 32_G0069_MuddyWater_Iran.py
...
# ==============================================================================
# 2. Extracted Input Data (MuddyWater / G0069)
# ==============================================================================

# Input data extracted from the document (32_G0069_MuddyWater_Iran.docx)
APT_GROUP_INFO = {
    "name": "MuddyWater",
    "mitre_id": "G0069", 
    "search_tags": [
        # Primary Identifiers
        "MuddyWater", "G0069", "MERCURY", "Seedworm", "StaticKitten",
        
        # Aliases and Campaign Names
        "TEMPZagros", "EarthVetala", "TA450", "MangoSandstorm", 
        "CobaltUlster",
        
        # Associated Malware and Tools
        "POWERSTATS", "PowGoop", "Canopy", "Starwhale", "SmallSieve",
        "Mori", "Thanos", "BugSleep", "LiteInject",
        
        # RMM Tools and Utilities
        "ScreenConnect", "Atera", "Syncro", "SimpleHelp", "RemoteUtilities"
    ]
}
