# python 35_G0010_Turla_Russia.py
...
# ==============================================================================
# 2. Extracted Input Data (Turla / G0010)
# ==============================================================================

# Input data extracted from the document (35_G0010_Turla_Russia.docx)
APT_GROUP_INFO = {
    "name": "Turla",
    "mitre_id": "G0010", 
    "search_tags": [
        # Primary Identifiers
        "Turla", "G0010", "Snake", "Waterbug", "VenomousBear",
        
        # Aliases and Campaign Names
        "Uroburos", "IronHunter", "WhiteBear", "Krypton", 
        "SecretBlizzard", "BELUGASTURGEON", "PensiveUrsa",
        
        # Associated Malware and Tools
        "Snake", "Uroburos", "ComRAT", "AgentBTZ", "Carbon",
        "Kazuar", "TinyTurla", "Crutch", "LightNeuron",
        "KOPILUWAK", "QUIETCANARY", "TunnusSched"
    ]
}
