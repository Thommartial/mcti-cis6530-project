# python 33_G0049_OilRig_Iran.py
...
# ==============================================================================
# 2. Extracted Input Data (OilRig / G0049)
# ==============================================================================

# Input data extracted from the document (33_G0049_OilRig_Iran.docx)
APT_GROUP_INFO = {
    "name": "OilRig",
    "mitre_id": "G0049", 
    "search_tags": [
        # Primary Identifiers
        "OilRig", "G0049", "APT34", "HelixKitten",
        
        # Aliases and Campaign Names
        "ATK40", "CobaltGypsy", "Crambus", "EUROPIUM", 
        "EarthSimnavaz", "EvasiveSerpens", "HazelSandstorm",
        "IRN2", "TA452", "TwistedKitten", "ITG13", "Chrysene",
        
        # Associated Malware and Tools
        "HELMINTH", "QUADAGENT", "ISMDoor", "ISMAgent", 
        "ISMInjector", "Tonedeaf", "BONDUPDATER", "SideTwist",
        "Disttrack", "Shamoon"
    ]
}
