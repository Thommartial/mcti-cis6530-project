# python 31_G0059_MagicHound_Iran.py
...
# ==============================================================================
# 2. Extracted Input Data (Magic Hound / G0059)
# ==============================================================================

# Input data extracted from the document (31_G0059_MagicHound_Iran.docx)
APT_GROUP_INFO = {
    "name": "Magic Hound",
    "mitre_id": "G0059", 
    "search_tags": [
        # Primary Identifiers
        "MagicHound", "G0059", "APT35", "CharmingKitten", "Phosphorus",
        
        # Aliases and Campaign Names
        "TA453", "CobaltIllusion", "CobaltMirage", "Newscaster", 
        "EducatedManticore", "MintSandstorm", "TunnelVision",
        
        # Associated Malware and Tools
        "PupyRAT", "MagicHoundLeash", "Leash", "MPKBot", "BASICSTAR",
        "PowerLess", "PowerLessBackdoor", "HYPERSCRAPE"
    ]
}
